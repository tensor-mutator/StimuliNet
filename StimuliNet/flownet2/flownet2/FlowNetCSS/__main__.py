...
def main(args: Namespace) -> None:
    if args.train:
       ...
       pipeline = Pipeline(FlowNetCSS, "DEFAULT", resolution, resolution, checkpoint_path=weights_path, frozen_config=frozen_config,
    ...
    if args.get_graph:
       pipeline = Pipeline(FlowNetCSS, "DEFAULT", (512, 512), (512, 512), checkpoint_path=weights_path, config=config.LOSS_EVENT+config.SAVE_FLOW)
