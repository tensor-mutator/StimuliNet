...
class FlowNetC(Network):
      ...
      def _fusion_stream(self, name: str) -> Callable:
          def create_fusion_stream(input: tf.Tensor) -> tf.Tensor:
              conv1 = Mutator.Conv2D(filters=64, kernel_size=(7, 7), strides=(2, 2), batch_norm=self._batch_norm,
                                     name=f'conv1{name}')(Mutator.pad(input, 3))
              conv2 = Mutator.Conv2D(filters=128, kernel_size=(5, 5), strides=(2, 2), batch_norm=self._batch_norm,
                                     name=f'conv2{name}')(Mutator.pad(conv1, 2))
              conv3 = Mutator.Conv2D(filters=256, kernel_size=(5, 5), strides=(2, 2), batch_norm=self._batch_norm,
      ...
      def _downsampling(self) -> None:
          ...
          conv3_1 = Mutator.Conv2D(filters=256, kernel_size=(3, 3), batch_norm=self._batch_norm, name='conv3_1')(Mutator.pad(fused))
          conv4 = Mutator.Conv2D(filters=512, kernel_size=(3, 3), strides=(2, 2), batch_norm=self._batch_norm, name='conv4')(Mutator.pad(conv3_1))
          conv4_1 = Mutator.Conv2D(filters=512, kernel_size=(3, 3), batch_norm=self._batch_norm, name='conv4_1')(Mutator.pad(conv4))
          conv5 = Mutator.Conv2D(filters=512, kernel_size=(3, 3), strides=(2, 2), batch_norm=self._batch_norm, name='conv5')(Mutator.pad(conv4_1))
          conv5_1 = Mutator.Conv2D(filters=512, kernel_size=(3, 3), batch_norm=self._batch_norm, name='conv5_1')(Mutator.pad(conv5))
          conv6 = Mutator.Conv2D(filters=1024, kernel_size=(3, 3), strides=(2, 2), batch_norm=self._batch_norm, name='conv6')(Mutator.pad(conv5_1))
          conv6_1 = Mutator.Conv2D(filters=1024, kernel_size=(3, 3), batch_norm=self._batch_norm, name='conv6_1')(Mutator.pad(conv6))

      def _upsampling(self) -> None:
          flow6 = Mutator.Conv2DFlow(name='flow6')(Mutator.get_operation(self._names.get('conv6_1')))
          flow6_up = Mutator.UpConv(name='flow6_up')(flow6)
          ...
          flow5 = Mutator.Conv2DFlow(name='flow5')(fuse5)
          flow5_up = Mutator.Upconv(name='flow5_up')(flow5)
          ...
          flow4 = Mutator.Conv2DFlow(name='flow4')(fuse4)
          flow4_up = Mutator.Upconv(name='flow4_up')(flow4)
          ...
          flow3 = Mutator.Conv2DFlow(name='flow3')(fuse3)
          flow3_up = Mutator.Upconv(name='flow3_up')(flow3)
          ...
          flow2 = Mutator.Conv2DFlow(name='flow2')(fuse2)
